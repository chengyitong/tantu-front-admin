                            ...
                            h('Poptip',{
                                ...
                                on: {
                                    'on-ok': () => {
                                        ...
                                        this.$axios.delete('/admin/tag/' + params.row.id).then(res => {
        ...
        addTag(name) {
            ...
            this.$refs[name].validate((valid) => {
                if (valid) {
                    ...
                    this.$axios.post('/admin/tag', this.addTagForm).then(res => {
                        if (res.code == 0) {
                            this.getTagLists();
        ...
        updateTag(name) {
            this.$refs[name].validate((valid) => {
                if (valid) {
                    ...
                    this.$axios.put('/admin/tag/' + this.updateTagForm.id, this.updateTagForm).then(res => {
                        if (res.code == 0) {
                            this.getTagLists();
