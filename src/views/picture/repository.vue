...
export default {
        ...
        return {
            ...
            list_columns: [{
                ...
                render: (h, params) => {
                    ...
                    let folder_str = folder_id == 0 ? '【默认专辑】' : '【' + params.row.folder.name + '】';
                    return h('span', {
                            style: {
                                display: 'block',
                                margin: '0 auto'
                        ...
                        h('Poptip',{
                            ...
                            h('img', {
                                domProps: {
                                    src: 'http://oym9dd6mv.bkt.clouddn.com/' + params.row.imgkey + '-slist',
                                    alt: params.row.name,
                                ...
                                on: {
                                    'click': () => {
                                        this.clickImg('http://oym9dd6mv.bkt.clouddn.com/' + params.row.imgkey + '-topimg')
                                    }
                                }
                            }),
                            h('div', {
                                ...
                                h('img', {
                                    domProps: {
                                        src: 'http://oym9dd6mv.bkt.clouddn.com/' + params.row.imgkey + '-nlist',
                                        alt: params.row.name,
                                        title: params.row.name
                                    },
                                    style: {
                        ...
                        h('Poptip',{
                            ...
                            on: {
                                'on-ok': () => {
                                    ...
                                    this.$axios.delete('/admin/product/' + params.row.id).then(res => {
    ...
    methods: {
        ...
        getProductLists(){
            ...
            this.$axios.get('/admin/product', { params: this.searchForm }).then(res => {
                this.$Spin.hide();
        ...
        updateProduct(){
            ...
            this.$axios.put('/admin/product/' + this.updateProductForm.id, this.updateProductForm).then(res => {
                if (res.code == 0) {
                    this.getProductLists();
        ...
        deleteProduct(){
            ...
            this.$axios.get('/admin/product/deletes', { params: { ids : this.product_ids } }).then(res => {
                this.getProductLists();
                this.$Message.success('删除成功');
            })
        },
