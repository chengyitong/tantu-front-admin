                        ...
                        h('Poptip',{
                            ...
                            on: {
                                'on-ok': () => {
                                    ...
                                    this.$axios.delete('/admin/category/' + params.row.id).then(res => {
        ...
        addCategory(name) {
            this.$refs[name].validate((valid) => {
                if (valid) {
                    ...
                    this.$axios.post('/admin/category', this.addCategoryForm).then(res => {
                        if (res.code == 0) {
                            this.getCategoryLists();
        ...
        updateCategory(name) {
            this.$refs[name].validate((valid) => {
                if (valid) {
                    ...
                    this.$axios.put('/admin/category/' + this.updateCategoryForm.id, this.updateCategoryForm).then(res => {
                        if (res.code == 0) {
                            this.getCategoryLists();
