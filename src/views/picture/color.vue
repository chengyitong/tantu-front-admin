                            ...
                            h('Poptip',{
                                ...
                                on: {
                                    'on-ok': () => {
                                        ...
                                        this.$axios.delete('/admin/color/' + params.row.id).then(res => {
        ...
        addColor(name) {
            this.$refs[name].validate((valid) => {
                if (valid) {
                    ...
                    this.$axios.post('/admin/color', this.addColorForm).then(res => {
                        if (res.code == 0) {
                            this.getColorLists();
        ...
        updateColor(name) {
            this.$refs[name].validate((valid) => {
                if (valid) {
                    ...
                    this.$axios.put('/admin/color/' + this.updateColorForm.id, this.updateColorForm).then(res => {
                        if (res.code == 0) {
                            this.getColorLists();
