<template>
    <div>
        <Form class="search-form" ref="searchForm" :model="searchForm" label-position="right" :label-width="80" inline>
            <Form-item label="自定义查询">
                <Input v-model="searchForm.nickname" placeholder="手机号/用户昵称/邮箱/QQ/微信" style="width:200px"></Input>
            </Form-item>
        ...
        <Modal v-model="addUserModalVisible" title="添加用户">
            ...
            <Form ref="addUserForm" :model="addUserForm" :rules="addUserFormRules" label-position="right" :label-width="80">
                <Form-item label="手机号" prop="name">
                    <Input v-model="addUserForm.name" placeholder="请输入手机号"></Input>
                </Form-item>
                <Form-item label="用户名" prop="name">
                    <Input v-model="addUserForm.name" placeholder="请输入用户名"></Input>
                </Form-item>
                <Form-item label="昵称" prop="nickname">
                    <Input v-model="addUserForm.nickname" placeholder="请输入用户昵称，用于展示在前端"></Input>
                </Form-item>
                <Form-item label="邮箱" prop="name">
                    <Input v-model="addUserForm.name" placeholder="请输入邮箱"></Input>
                </Form-item>
        ...
        <!-- 编辑用户弹框 -->
        <Modal v-model="updateUserModalVisible" title="添加用户">
            <div slot="footer">
...
export default {
    ...
    methods: {
        ...
        delUser(params) {
            this.$Modal.confirm({
                title: '温馨提示',
                content: '<p>确定删除该用户吗？</p><p>该操作不可逆转，请谨慎操作！</p>',
                loading: false,
                onOk: () => {
